...
```{r}
# Label the customer with 1 for creditworthy and 0 for non-creditworthy
...
Total 400 out the 500 new customers are predicted as creditworthy. We can transfer the prediction result with predicted customer label to relevant department for loan application proceeding.
