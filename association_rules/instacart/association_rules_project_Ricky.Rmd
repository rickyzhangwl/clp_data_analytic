...
3. What will customers purchase before buying specific item? X
4. What will customers purchase after buying specific item? X

what association rules can be drawn from the items?
